...
Architecture is open for, but does not yet implement:

- TTS replacement for redacted entities (Kokoro)
- NER ensemble routing by entity type (DeBERTa→PER, Flair→LOC/ORG)
- Presidio + spaCy for pattern-based PII (phone, email, SSN)
